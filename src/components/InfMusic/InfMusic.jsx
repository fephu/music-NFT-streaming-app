                              ...
                              <div className='flex items-center justify-between'>
                                 <div className='flex '>
                                    ...
                                    <div className='inline '>
                                       <span className='font-normal text-base'>Sale ends 18 tháng 6, 2023 at 7:23 CH </span>
                                    </div>
                                 </div>
                              </div>
                           </div>
                                 ...
                                 <div className='block'>
                                    ...
                                    <div className='flex mb-2 flex-wrap'>
                                       <div className='flex items-center font-semibold max-w-full'>
                                          <div className='flex items-center'>
                                             <div className='text-3xl font-semibold'>0,053 ETH</div>
                                             <span className='ml-2 mt-4 text-gray-400'>$92,46</span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div className='w-full contents'>
                                    <div className='relative overflow-hidden w-3/4'>
                                       <div className='whitespace-nowrap'>
                                          <button className='inline-flex flex-row items-center rounded-xl rounded-tr-none rounded-br-none bg-blue-500 h-14 w-full justify-center text-lg font-semibold text-white'>Buy Now</button>
                                       </div>
                                    </div>
